          ...
          <div className="bg-white shadow rounded-lg p-3 sm:p-6">
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 sm:mb-6 gap-3">
              <div className="flex justify-between items-center gap-2">
                ...
                <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 whitespace-nowrap">{currentYear}年{currentMonth}月</h2>
                <button
                  onClick={() => changeMonth(1)}
                  className="px-3 py-2 sm:px-4 sm:py-2 bg-gray-200 rounded hover:bg-gray-300 text-base sm:text-sm text-gray-900 font-medium min-w-[44px] min-h-[44px] flex items-center justify-center"
                >
              ...
              <div className="flex items-center gap-2 sm:gap-4 justify-center">
                <button
                  ...
                  disabled={processing}
                  className="px-3 py-2 sm:px-4 sm:py-2 bg-yellow-500 text-white rounded hover:bg-yellow-600 disabled:bg-gray-400 text-sm sm:text-sm font-medium min-h-[44px]"
                >
                  {processing ? "抽選中..." : "一括抽選"}
                </button>
                <button
                  ...
                  disabled={processing}
                  className="px-3 py-2 sm:px-4 sm:py-2 bg-red-600 text-white rounded hover:bg-red-700 disabled:bg-gray-400 text-sm sm:text-sm font-medium min-h-[44px]"
                >
                  一括確定
                </button>
              </div>
            ...
            <div className="mb-4 p-3 sm:p-4 bg-gray-50 rounded text-sm">
              <p className="font-semibold mb-2 sm:mb-3 text-sm text-gray-900">凡例</p>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                <div className="flex items-center gap-2">
                  <div className="flex items-center gap-1">
                    <div className="w-14 sm:w-16 h-7 bg-red-300 rounded flex items-center justify-center text-[10px] sm:text-xs text-gray-900 shrink-0 px-1">確定以外</div>
                  ...
                  <span className="text-sm font-medium text-gray-900">レベル1</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="flex items-center gap-1">
                    <div className="w-14 sm:w-16 h-7 bg-blue-300 rounded flex items-center justify-center text-[10px] sm:text-xs text-gray-900 shrink-0 px-1">確定以外</div>
                  ...
                  <span className="text-sm font-medium text-gray-900">レベル2</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="flex items-center gap-1">
                    <div className="w-14 sm:w-16 h-7 bg-green-300 rounded flex items-center justify-center text-[10px] sm:text-xs text-gray-900 shrink-0 px-1">確定以外</div>
                  ...
                  <span className="text-sm font-medium text-gray-900">レベル3(期間内)</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="flex items-center gap-1">
                    <div className="w-14 sm:w-16 h-7 bg-gray-300 rounded flex items-center justify-center text-[10px] sm:text-xs text-gray-900 shrink-0 px-1">確定以外</div>
                  ...
                  <span className="text-sm font-medium text-gray-900">レベル3(期間外)</span>
                </div>
              </div>
            </div>
          </div>
              ...
              >
                <div className="flex flex-col gap-2 sm:gap-3 mb-2">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                    <div className="flex items-center gap-2">
                      <label className="text-xs sm:text-sm text-gray-700 whitespace-nowrap">枠数:</label>
                      <input
                        type="number"
                        min="0"
                        value={capacities[day.date] ?? ""}
                        onChange={(e) => handleMaxPeopleChange(day.date, e.target.value)}
                        className="w-20 border border-gray-300 rounded px-2 py-1 text-sm text-gray-900 placeholder:text-gray-400 min-h-[44px]"
                        placeholder="未設定"
                      />
                    </div>
                    <div className="flex gap-1 sm:gap-2 flex-wrap">
                      <button
                        ...
                        disabled={processing}
                        className="px-2 sm:px-3 py-2 bg-yellow-500 text-white rounded text-xs sm:text-sm hover:bg-yellow-600 disabled:bg-gray-400 min-h-[44px]"
                      >
                        抽選
                      </button>
                      <button
                        ...
                        disabled={processing}
                        className="px-2 sm:px-3 py-2 bg-red-600 text-white rounded text-xs sm:text-sm hover:bg-red-700 disabled:bg-gray-400 min-h-[44px]"
                      >
                        確定
                      </button>
                      <button
                        ...
                        disabled={processing}
                        className="px-2 sm:px-3 py-2 bg-orange-600 text-white rounded text-xs sm:text-sm hover:bg-orange-700 disabled:bg-gray-400 min-h-[44px]"
                      >
                        確定解除
                      </button>
                    </div>
